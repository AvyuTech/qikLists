...
/**
 * FbaShipmentReportDataSearch represents the model behind the search form about `app\models\FbaShipmentReportData`.
 */
class FbaShipmentReportDataSearch extends FbaShipmentReportData
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = FbaShipmentReportData::find();
