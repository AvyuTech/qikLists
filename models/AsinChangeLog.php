...
/**
 * This is the model class for table "asin_change_log".
 *
 * @property integer $id
 * @property string $sku
 ...
 */
class AsinChangeLog extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            [['asin'], 'required'],
            [['new_value', 'old_value', 'old_array', 'new_array'], 'string'],
            [['date'], 'safe'],
            [['diff_status', 'created_at', 'updated_at', 'ac_status'], 'integer'],
